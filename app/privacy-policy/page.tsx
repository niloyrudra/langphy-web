...
const PrivacyPolicyPage = () => (
    <Main>    
        ...
        <Section className="mt-20">
            <Paragraph className='text-justify' content="This Privacy Policy explains how Langphy, developed and operated by Niloy Rudra and Kheya Nandi ('we', 'us', or 'our'), collects, uses, stores, protects, and shares your personal information when you use the Langphy Android application ('App'). By using the App, you agree to the practices described in this policy." />
        </Section>

        {/* Section 1 */}
        <Section title="1. Who This Policy Applies To">
            <Paragraph className='text-justify' content="This policy applies to all users of the Langphy Android application, regardless of geographic location. Users in the European Economic Area (EEA), United Kingdom, or other jurisdictions with specific data protection laws may have additional rights described in Section 10." />
        </Section>

        {/* Section 2 */}
        <Section title="2. Information We Collect"> 
            <SubSection title="2.1 Information You Provide Directly">
                <Paragraph className='text-justify' content="When you register and use Langphy, you provide:" />
            ...
            <SubSection title="2.2 Learning and Activity Data">
                <Paragraph className='text-justify' content="As you use the App, the following data is generated and stored to power your learning experience:" />
                <ul className="list-disc pl-6 space-y-1">
                ...
                <Paragraph className='text-justify' content="This data is first stored locally on your Android device in a SQLite database (offline-first), then synchronized to our secure backend servers when an internet connection is available." />
            </SubSection>

            <SubSection title="2.3 Speech and Audio Data">
                <Paragraph className='text-justify' content="When you use the speech recognition features:" />
                <ul className="list-disc pl-6 space-y-1">
            ...
            <SubSection title="2.4 Technical and Device Data">
                <Paragraph className='text-justify' content="We may collect limited technical data through our own infrastructure, including:" />
                <ul className="list-disc pl-6 space-y-1">
            ...
            <SubSection title="2.5 Information We Do Not Collect">
                <Paragraph className='text-justify' content="Langphy does not collect:" />
                <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="3. How We Use Your Information">
            <Paragraph className='text-justify' content="We use the information collected solely for the following purposes:" />
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="4. Legal Basis for Processing (GDPR)">
            <Paragraph className='text-justify' content="For users in the EEA or UK, we process personal data under the following GDPR legal bases:" />
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="5. Data Storage, Retention, and Security">
            ...
            <SubSection title="5.3 Security Measures">
                <Paragraph className='text-justify' content="We implement the following protections:" />
                <ul className="list-disc pl-6 space-y-1">
                ...
                <Paragraph className='text-justify' content="No system is entirely immune to security threats. We encourage you to use a strong, unique password and to contact us immediately at support@langphy.com if you believe your account has been compromised." />
            </SubSection>
        </Section>

        {/* Section 6 */}
        <Section title="6. Data Sharing and Disclosure">
            <Paragraph className='text-justify' content="We do not sell, rent, trade, or share your personal data with third parties for commercial or marketing purposes. Data is shared only in the following limited circumstances:" />
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="7. Future Paid Features and Billing">
            <Paragraph className='text-justify' content="Langphy is currently free. When we introduce optional paid membership features, any payment processing will be handled entirely by the Google Play Store's billing infrastructure. We will not directly collect or store your payment card information. Any data collected in connection with a subscription will be governed by a supplementary privacy notice presented at the time of subscription." />
        </Section>

        {/* Section 8 */}
        <Section title="8. Cookies and Local Storage">
            <Paragraph className='text-justify' content="Langphy uses local device storage (SQLite) to store your learning data for offline functionality. This is essential to the core functionality of the App and cannot be disabled independently without uninstalling the application. This is not browser-based cookie tracking; it is a technical requirement of the offline-first architecture." />
        </Section>

        {/* Section 9 */}
        <Section title="9. Children's Privacy">
            <Paragraph className='text-justify' content="Langphy is not directed at children under the age of 13. We do not knowingly collect personal information from children under 13. If you are a parent or guardian and believe your child has created an account without your consent, please contact us at support@langphy.com and we will promptly delete the information." />
        </Section>

        {/* Section 10 */}
        <Section title="10. Your Rights and Choices">
            <Paragraph className='text-justify' content="Regardless of your location, you have the following rights:" />
            <ul className="list-disc pl-6 space-y-1">
            ...
            <Paragraph className='text-justify' content="Users in the EEA or UK additionally have the right to object to processing, restrict processing, and lodge a complaint with their national data protection authority. We will respond to rights requests within 30 days." />
        </Section>

        {/* Section 11 */}
        <Section title="11. Additional Rights for EEA and UK Users">
            <Paragraph className='text-justify' content="" />
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="12. International Data Transfers">
            <Paragraph className='text-justify' content="Our backend infrastructure may be hosted on servers located in different countries. Where data is transferred internationally, we take steps to ensure it is protected to a standard equivalent to that required under applicable data protection laws." />
        </Section>

        {/* Section 13 */}
        <Section title="13. Changes to This Privacy Policy">
            <Paragraph className='text-justify' content="We may update this Privacy Policy over time, including when we introduce paid features or change our data practices. We will update the effective date and provide reasonable notice of material changes through the application or by email. Continued use of the App after changes constitutes acceptance of the updated policy." />
        </Section>

        {/* Section-14 ============================================= */}
        <Section title="14. Contact" className="w-full">
            <Paragraph className='text-justify' content="For privacy-related questions, requests, or concerns:"/>
            <ContactDetails />
        </Section>
