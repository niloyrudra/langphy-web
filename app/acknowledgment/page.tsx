...
const AcknowledgmentPage = () => (
    <Main>
        ...
        <Section className="mt-20">
            <Paragraph className='text-justify' content="This Disclaime and Acknowledgment supplements the Terms of Service and Privacy Policy of Langphy. It sets out important limitations and clarifications users should understand before relying on the application or its content for any purpose beyond personal language learning." />
        </Section>

        {/* Section-1 */}
        <Section title="1. About the Application and Its Team">
            <Paragraph className='text-justify' content="Langphy is an independent German language learning application developed by Niloy Rudra (software development) and Kheya Nandi (product design). It is an independent project with no institutional affiliation, no external investors, and no connection to any language certification authority." />
            <Paragraph className='text-justify' content="At the time of this writing, Langphy is available exclusively on Android and is provided free of charge. We intend to register a formal business entity in the future. In the meantime, all responsibility for the application rests with the individual developers named above." />
        </Section>

        {/* Section-2 */}
        <Section title="2. Educational Disclaimer">
            <SubSection title="2.1 No Guarantee of Language Proficiency">
                <Paragraph className='text-justify' content="Langphy is a supplementary tool designed to support German language learning. We make no representation or guarantee regarding any specific level of language proficiency, fluency, or skill acquisition as a result of using the application. Language learning is a complex, deeply individual process influenced by many factors, including:" />
        ...
        <Section title="12. Contact and Corrections" className="w-full">
            <Paragraph className='text-justify' content="For content errors, technical concerns, or any other queries:" />
            <ContactDetails />
        </Section>
