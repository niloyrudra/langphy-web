    ...
    <Main>
        ...
        <Section title="4. The Application — Free and Future Paid Features">
            <SubSection title="4.1 Free Tier">
                <Paragraph content="At launch, Langphy is entirely free to use. All currently available lesson content, learning modalities, and features are accessible without payment. We do not display advertisements in the free version of the application." />
            </SubSection>

            <SubSection title="4.2 Future Paid Membership">
                <Paragraph content="We plan to introduce an optional paid membership tier in a future version of the application. This paid tier will offer additional features, content, or capabilities beyond what is available in the free tier. The free tier will remain available, and access to currently free features will not be removed or restricted solely because a paid tier has been introduced." />
                <Paragraph content="When paid features are introduced, the following will apply:" />
                <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="5. Permitted and Prohibited Uses">
            <SubSection title="5.1 Permitted Use">
                <Paragraph content="Langphy is licensed to you for your personal, non-commercial language learning purposes only. You may use the application on any Android device that you own or control and that meets the technical requirements of the application." />
            </SubSection>

            <SubSection title="5.2 Prohibited Conduct">
                <Paragraph content="You agree not to, and agree not to permit or assist any third party to:" />
                <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="6. Speech Recognition and Microphone Access">
            <Paragraph content="Langphy includes speech-based learning exercises that require access to your device's microphone. By enabling microphone access when prompted:" />
            <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="17. Contact" className="w-full">
            <Paragraph content="For questions or concerns regarding these Terms:"/>
            <ContactDetails />
        </Section>
